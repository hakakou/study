using MauiStudyApp.Domain.Repositories;
using MauiStudyApp.Domain.Services;
using MauiStudyApp.Infrastructure.Data;
using Microsoft.EntityFrameworkCore;
using System.Collections;

namespace MauiStudyApp.Infrastructure.Repositories
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : class
    {
        ...
        public GenericRepository(EntitiesContext context, ICacheService cacheService)
        {
