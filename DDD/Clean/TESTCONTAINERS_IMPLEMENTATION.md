...
**Updated `tests\Clean.FunctionalTests\Clean.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\Clean.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\Clean.FunctionalTests\Clean.FunctionalTests.csproj
```
