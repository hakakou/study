...
namespace LanguageTests.IO
{
    public class Person
    {
        ...
        public HashSet<IO.Person> Children { get; set; }
    ...
    {
        List<IO.Person> people = new List<IO.Person> {
            new IO.Person(20000M) { FirstName = "Alice", LastName = "Smith",
                DateOfBirth = new DateTime(1974, 3, 14) },
            new IO.Person(40000M) { FirstName = "Bob", LastName = "Jones",
                DateOfBirth = new DateTime(1969, 11, 23) },
            new IO.Person(20000M) { FirstName = "Charlie", LastName = "Cox",
                DateOfBirth = new DateTime(1984, 5, 4), Children = new HashSet<IO.Person>
                    { new IO.Person(0M) { FirstName = "Sally", LastName = "Cox",
        ...
        {
            var xs = new XmlSerializer(typeof(List<IO.Person>));
