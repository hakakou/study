...
namespace LanguageTests.Security;

public class AuthenticationTests
{
    private readonly ITestOutputHelper t;

    public AuthenticationTests(ITestOutputHelper testOutputHelper)
    {
        t = testOutputHelper;
    }
    ...
    {
        Security.Protector.Register("Alice", "Pa$$w0rd", new[] { "Admins" });
        Security.Protector.Register("Bob", "Pa$$w0rd", new[] { "Sales", "TeamLeads" });
        Security.Protector.Register("Eve", "Pa$$w0rd");

        Security.Protector.LogIn("Bob", "Pa$$w0rd");
