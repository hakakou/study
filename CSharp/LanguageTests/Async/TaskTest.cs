...
namespace LanguageTests.Async
{
    ...
    public class TaskTest
    {
        ...
        public TaskTest(ITestOutputHelper outputHelper)
        {
            ...
            Async.Recorder.Log += (s, e) => outputHelper.WriteLine(e);
        }
        ...
        public Task Block2()
        {
            ...
            Async.Recorder.Start();

            var producerThread = Task.Factory.StartNew(() =>
            {
                Async.Recorder.Report("Producer start");
                for (int i = 0; i < 10; ++i)
                {
                    bCollection.Add(i);
                    Thread.Sleep(100);
                }
                Async.Recorder.Report("Producer loop ended");
                bCollection.CompleteAdding();
            });

            var consumerThread = Task.Factory.StartNew(() =>
            {
                Async.Recorder.Report("Consumer start");
                ...
                Async.Recorder.Report("Consumer end");
            });
        ...
        public async Task Block4()
        {
            ...
            foreach (var item in bCollection.GetConsumingEnumerable())
                Async.Recorder.Report(item.ToString());

            Async.Recorder.Report("Finished");
        }
        ...
        public async Task Test4()
        {
            ...
            string res = await new Async.TestClass();
